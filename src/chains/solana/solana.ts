...
export class Solana implements Solanaish {
  ...
  async getTransaction(
    ...
    if (this.cache.keys().includes(payerSignature)) {
      ...
      return this.cache.get(payerSignature) as VersionedTransactionResponse;
    } else {
  ...
  public async getTransactionStatusCode(
    txData: VersionedTransactionResponse | null
  ...
  cacheTransactionReceipt(tx: VersionedTransactionResponse) {
